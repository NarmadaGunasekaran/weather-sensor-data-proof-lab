...
Open `demo-slides.html` for the recommended three-slide recruiter demo: identify anonymous fields in a combined weather packet, prove lossless reconstruction, then compare the sensor-aware representation with standard GZIP. Use the next/previous buttons to present it one page at a time.
